...
<div class="col-md-8 border-start-0 border-md-start ps-4 mt-4 mt-lg-0">
    <div data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
        <div class="overflow-auto" style="height: 500px;" id="item-1">
            <h5>Alterar Processos Seletivos</h5>
            <div class="col-2 py-2">
                <a class="btn btn-success float-right" href="?p=processoseletivo/salvar">Cadastrar</a>
            </div>
            <div class="card shadow">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <!--foreach aqui BEGIN-->
                        <?php
                        //estabelecer conversa com a class ProcessoSeletivo
                        ...
                        ?>
                            <tr class="align-middle">
                                <td><?= $id ?></td>
                                <td><?= $titulo ?></td>
                                <td class="w-25"><?= $unidade ?></td>
                                <td class="w-25"><?= $data ?></td>
                                <td class="w-25"><img class="w-100" height="100" src="processoseletivo/img/<?= $imagem ?>" alt=""></td>
                                <td class="w-25 text-center">
                                    <a href="?p=processoseletivo/salvar&id=<?= $id ?>" class="btn btn-primary ml-2">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="col-md-3">
                                                        <a class="nav-link w-100 p-0 pe-2" href="?p=processoseletivo/excluir&id=<?= $id ?>"><button type="button" class="btn btn-danger w-100" data-bs-dismiss="modal">Excluir</button></a>
                                                    </div>
